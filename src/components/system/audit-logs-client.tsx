      ...
      >
        <div className="relative">
          ...
          <input
            ...
            className="w-full rounded-xl border border-border bg-white/3 py-2 pl-10 pr-4 text-sm text-white placeholder-muted-foreground focus:border-indigo-500 focus:outline-none focus:ring-1 focus:ring-indigo-500"
          />
        </div>
        ...
        <div className="relative">
          ...
          <select
            ...
            className="w-full appearance-none rounded-xl border border-border bg-white/3 py-2 pl-10 pr-8 text-sm text-white focus:border-indigo-500 focus:outline-none"
          >
            {modules.map((m) => (
      ...
      <div className="overflow-hidden rounded-2xl border border-border bg-card">
        <div className="overflow-x-auto">
          <table className="w-full border-collapse text-left text-sm text-muted-foreground">
            <thead className="bg-white/3 text-xs font-bold uppercase tracking-wider text-white border-b border-border">
              <tr>
            ...
            <tbody className="divide-y divide-border/60">
              {initialData.logs.length > 0 ? (
                initialData.logs.map((log) => (
                  <tr key={log.id} className="transition-colors hover:bg-white/2">
                    <td className="px-6 py-4 whitespace-nowrap text-xs text-white/80">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="flex items-center gap-2">
                        <div className="flex h-7 w-7 items-center justify-center rounded-full bg-white/5 text-xs font-semibold text-indigo-400">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <span className="inline-flex items-center gap-1.5 rounded-full bg-white/5 border border-border/80 px-2.5 py-0.5 text-xs font-medium text-muted-foreground">
                    ...
                    <td className="px-6 py-4 text-xs font-medium text-white/90 max-w-md break-words">
                      {log.details}
                    </td>
